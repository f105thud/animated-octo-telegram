...
public class GoToEditObservations {
	public static void main(String[] args) throws IOException {
		// Specify the file location I used . operation here because
				...
				driver.findElement(By.cssSelector("#wrapper > div > div:nth-child(2) > div:nth-child(2) > div > ul > li:nth-child(4) > a"));
				
				String expectedtitle = "https://www.inaturalist.org/observations/matt-roe";
				String actualtitle = "";
				
				actualtitle = driver.getCurrentUrl();
				
				if (actualtitle.contentEquals(expectedtitle)) {
		            System.out.println("Profile tab displayed!");
				}
