...
public class GoToJournal {
	...
	public static void main(String[] args) throws IOException {
		...
		driver.findElement(By.cssSelector("#wrapper > div > div:nth-child(2) > div:nth-child(2) > div > ul > li:nth-child(5) > a"));
		
		String expectedtitle = "https://www.inaturalist.org/journal/matt-roe";
		String actualtitle = "";
		
		actualtitle = driver.getCurrentUrl();
		
		if (actualtitle.contentEquals(expectedtitle)) {
            System.out.println("Journal tab displayed!");
