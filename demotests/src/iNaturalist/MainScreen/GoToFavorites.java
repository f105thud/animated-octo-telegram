...
public class GoToFavorites {
	...
	public static void main(String[] args) throws IOException {
		...
		driver.findElement(By.cssSelector("#wrapper > div > div:nth-child(2) > div:nth-child(2) > div > ul > li:nth-child(9) > a"));
		
		String expectedtitle = "https://www.inaturalist.org/favorites/matt-roe";
		String actualtitle = "";
		
		actualtitle = driver.getCurrentUrl();
		
		if (actualtitle.contentEquals(expectedtitle)) {
            System.out.println("Favorites tab displayed!");
